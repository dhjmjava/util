package com.daihui.common.util;
...
public class DateUtil {
    ...
    public static String LongTimeToString(Long time){
        return LongTimeToString( time ,"yyyy-MM-dd HH:mm:ss" );
    }
    ...
    /**
     * function:将时间字符串转为时间戳
      * @param dateStr
     * @return java.lang.Long
     * @author daihui
     * @since 2018/1/11 0011 22:56
     */
    public static Long  strDateToTime(String dateStr){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Long time = null;
        try {
